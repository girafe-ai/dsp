...
Если не получится добиться чисто отклика для работы - не страшно. Реализуйте сам алгоритм, и предложите потенциальные решения и/или модификации (выравнивание, условия записи и т.д.). Достаточно грамотно описать импакт потенциальных модификаций на результат. Если к тому же сделаете опциональный 4 модуль - отсутствие результата в этом модуле не будет наказываться.
