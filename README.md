...
Примечание ко всем этапам: чтение и запись файлов в питоне лучше делать через библиотеку 'soundfile' ('soundfile.read', 'soundfile.write'), предпочтительнее формат .wav, семплрейт 48кГц
